# script to generate on local nuts-gmail.pickle
import pickle
import os
...
json_path = os.path.join(os.getcwd(), 'XXXXXXXXXX.apps.googleusercontent.com.json')
...
pickle_path = os.path.join(os.getcwd(), 'nuts-gmail.pickle')
